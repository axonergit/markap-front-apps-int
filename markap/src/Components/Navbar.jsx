                ...
                <div className="flex-none">
                    <div className="dropdown dropdown-end">
                        <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
                            ...
                            <svg
                                ...
                                <span className="badge badge-sm indicator-item">8</span> { /**Aca es donde va la cantidad de productos **/}
                            </div>
                        </div>
                        <div
                            tabIndex={0}
                            className="card card-compact dropdown-content bg-base-100 z-[1] mt-3 w-52 shadow">
                            <div className="card-body"> { /**Aca es donde va la info del carrito **/}
                                <span className="text-lg font-bold">0 Elementos</span>
                    ...
                    <div className="dropdown dropdown-end">
                        ...
                        <ul
                            ...
                            <li><Link to="/carrito">Compras pasadas</Link></li>
