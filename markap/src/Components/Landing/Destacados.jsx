...
export default function Destacados() {
    ...
    return (
        <div className="w-full flex flex-col items-center pt-4 pb-8">
            <h1 className="text-3xl font-bold text-black mb-5 py-5">
            ...
            <div className="carousel rounded-box w-full h-full">
                {data?.map((producto, index) => (
                    ...
                    >
                    <Link to={`/producto/${producto.id}`} className="shadow-black">
                        <div className="p-0 flex flex-col">
                            <Image className="object-contain h-[500px] w-[500px] bg-white rounded-t-lg rounded-b-none"
                                   src={producto.imagen} alt={producto.nombre}>
                            </Image>
                            <p className="p-6 bg-white
                                rounded-b-lg text-center text-2xl shadow-md">
